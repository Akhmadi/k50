...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils__ = __webpack_require__("./resources/assets/js/utils/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_page_app__ = __webpack_require__("./resources/assets/js/components/page-app.js");
...
window.smoothScroll = __webpack_require__("./node_modules/smoothscroll/smoothscroll.js");

window.videojs = __webpack_require__("./node_modules/video.js/dist/video.cjs.js");
window.Vue = __webpack_require__("./node_modules/vue/dist/vue.common.js");

window.Masonry = __webpack_require__("./node_modules/masonry-layout/masonry.js");
Vue.use(__WEBPACK_IMPORTED_MODULE_2_vue_the_mask___default.a);
/**
...
var app = new Vue(__WEBPACK_IMPORTED_MODULE_1__components_page_app__["a" /* default */]);

__WEBPACK_IMPORTED_MODULE_0__utils__["a" /* default */].onReady(function () {
    var btnToUp = document.querySelector('.fixed_up_button');
    ...
    __WEBPACK_IMPORTED_MODULE_0__utils__["a" /* default */].forEach(document.querySelectorAll('.share-data'), function (el) {
        ...
        el.addEventListener('click', function (e) {
            ...
            if (provider) {
                try {
                    __WEBPACK_IMPORTED_MODULE_0__utils__["a" /* default */].sharer()[provider](el.getAttribute('data-url'), el.getAttribute('data-title'), el.getAttribute('data-image'), el.getAttribute('data-desc'));
                } catch (e) {
    ...
    if (document.querySelector('.main__block .main__slider')) {
        var mainSlider = new Swiper('.main__block .main__slider', {
    ...
    if (document.querySelector('.life__section .gallery')) {
        var msnry = new Masonry(document.querySelector('.life__section .gallery'), {
    ...
    if (document.querySelector('.our__speakers.swiper-container')) {
        var speakersSlider = new Swiper('.our__speakers.swiper-container', {
            slidesPerView: 6,
            autoplay: 4000,
            loop: true,
    ...
    if (document.querySelector('.our__partners.swiper-container')) {
        var partnersSlider = new Swiper('.our__partners.swiper-container', {
            slidesPerView: 4,
            autoplay: 4000,
            loop: true,
            cssWidthAndHeight: 'height'
    ...
    var showModalButtons = document.querySelectorAll('.btn.show-modal, .btn.close-modal, .js-toggle-modal');

    showModalButtons.forEach(function (b) {
    ...
    var tabControls = document.querySelectorAll('.tabs');

    if (tabControls) tabControls.forEach(function (t) {

        t.querySelectorAll('.tab__header > .tab').forEach(function (hTab) {
            hTab.addEventListener('click', function (e) {
                e.preventDefault();
                e.stopPropagation();

                t.querySelectorAll('.tab__header .tab.is__active').forEach(function (hActiveTab) {
                    hActiveTab.classList.remove('is__active');
                });
                hTab.classList.add('is__active');
                var tabId = hTab.getAttribute('data-tab-id');

                t.querySelectorAll('.tab__content > .tab.is__active').forEach(function (hActiveTab) {
                    hActiveTab.classList.remove('is__active');
                });
    ...
    if (videoContainers.length) {
        ...
        //
        videoContainers.forEach(function (v) {
    ...
    var macyContainers = document.querySelectorAll('.macy-container');

    if (macyContainers.length) {

        __WEBPACK_IMPORTED_MODULE_0__utils__["a" /* default */].forEach(macyContainers, function (macyContainerElement) {
            var macyContainer = new Macy({
    ...
    if (document.querySelector('.checkbox')) {
        ...
        var sendbtn = document.getElementById('btn_stdt_form');
    ...
    var packageList = document.getElementById('packages');
    var packageInfo = document.getElementById('package_info');
...
/***/ "./resources/assets/js/components/page-app.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ __webpack_exports__["a"] = ({
        ...
        if (messages.length) {
            var tmr = setTimeout(function () {
                for (var i = 0; i <= messages.length - 1; i++) {
                    if (messages[i].length > 0) _this.showMessage(messages[i]);
                };
    ...
    methods: {
        ...
        checkFeedback: function checkFeedback() {
            ...
            return this.feedbackForm.name && this.feedbackForm.email && this.feedbackForm.subject && this.feedbackForm.text;
        },
        feedback: function feedback() {
            ...
            if (this.checkFeedback()) {
                ...
                axios.post(baseUrl + '/api/feedback', this.feedbackForm).then(function (resp) {
                    _this2.showMessage('Спасибо за обратную связь!');
                    _this2.clearFeedback();
                }).catch(function (err) {
                    _this2.showMessage('Возникли проблемы, мы уже занимаемся решением!');
                    console.log(err);
                });
            } else {
        ...
        subscribe: function subscribe() {
            ...
            if (this.validateEmail(this.subscribeEmail)) {
                ...
                axios.post(baseUrl + '/api/subscribe', { email: this.subscribeEmail }).then(function (resp) {
                    _this3.showMessage('Спасибо за подписку, будем держать вас в курсе!');
                }).catch(function (err) {
                    _this3.showMessage('Возникли проблемы, мы уже занимаемся решением!');
                    console.log(err);
                });
        ...
        showMessage: function showMessage(messageText) {
            var _this4 = this;

            var message = { text: messageText, tmr: null, visible: true, id: Math.random() };
            this.messages.push(message);

            message.tmr = setTimeout(function () {
                _this4.deleteMessage(message);
            }, 10000);
        },
        ...
        setFormFile: function setFormFile(e) {
            var inputName = e.target.getAttribute('name');

            this.$set(this.studentRegisterForm.data, inputName, e.target.files[0]);
        },
        searchItemsByGroup: function searchItemsByGroup(group) {
            return this.search.items.filter(function (i) {
                return i.type === group;
            });
        },
        toggleSearchPanel: function toggleSearchPanel() {
        ...
        doSearch: function doSearch() {
            ...
            axios.get(baseUrl + '/api/search/' + this.search.value).then(function (resp) {
                _this5.search.items = resp.data.items;
            }).catch(function (err) {
        ...
        searchByPhone: function searchByPhone() {
            ...
            axios.post('/api/search-by-phone', {
                ...
                if (response.data.length == 0) {
                    ...
                    _this6.userSobytiyaRegister.first_name = response.data.first_name;
                    _this6.userSobytiyaRegister.last_name = response.data.last_name;
                    _this6.userSobytiyaRegister.phone = response.data.phone;
                    _this6.userSobytiyaRegister.email = response.data.email;
                    _this6.userSobytiyaRegister.company = response.data.company;
                    _this6.userSobytiyaRegister.position = response.data.position;
                    _this6.showMessage('Добрый день, ' + _this6.userSobytiyaRegister.last_name + ' ' + _this6.userSobytiyaRegister.first_name + '. Будем рады видеть Вас на нашем форуме');
                }
        ...
        //
        // },
        searchValueChanged: function searchValueChanged(e) {
            var _this7 = this;
            ...
            try {
                ...
                if (e.target.value.trim() !== '') {
                    ...
                    this.search.tmr = setTimeout(function () {
